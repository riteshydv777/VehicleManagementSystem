...
public class AddPersonalDetail extends JFrame implements ActionListener{
    ...
    AddPersonalDetail(String username){
        setBounds(450,200,834,550);
        setLayout(null);
        ...
        add(tfemail);
         ...
         // add image to frame
         ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/addper.jpg"));
         ...
         try{
            Conn c = new Conn();
            String query = "select*from customer where username = '"+labelusername+"'" ;
